...
from animuxbot.general import pin, pin_mute, love, help_message, about, function_di
...
class Bot(object):
    ...
    def run(self, port: int):
        ...
        self.updater.bot.set_webhook('https://ponyrevolution-bot.herokuapp.com/' + self.token)
        self.updater.idle()
